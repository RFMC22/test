pipeline{
  ...
  post{
    always{
      publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: 'cypress-demo-framework/cypress/report', reportFiles: 'index.html', reportName: 'HTML Report', reportTitles: ''])
    }
  }
}